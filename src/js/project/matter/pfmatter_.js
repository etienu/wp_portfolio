...
window.onload = function() {
    ...
    var c_yoyoimg = Composites.stack(220, 352, 1, 1, 1, 1, function(x, y) {
        ...
        return Bodies.fromVertices(x, y, [vp_yoyoi], {
            ...
            render: {
                ...
                lineWidth: 1,
                //スプライトの設定
                sprite: { texture: wppath + '/img/jsmatter/matter_yoyo2.png' }
            }
        }, true);
    });
    //  [yoyo画像:口変化ver]
    var c_yoyoimg2 = Composites.stack(1220, 352, 1, 1, 1, 1, function(x, y) {
        return Bodies.fromVertices(x, y, [vp_yoyoi], {
            isStatic: true,
            collisionFilter: { category: 0x0002 },
            render: { sprite: { texture: wppath + '/img/jsmatter/matter_yoyo.png' } }
        }, true);
    });
    ...
    var c_logo = Composites.stack(450, 30, 1, 1, 1, 1, function(x, y) {
        ...
        return Bodies.fromVertices(x, y, [vp_logo], {
            ...
            render: {
                ...
                strokeStyle: color,
                lineWidth: 1,
                sprite: { texture: wppath + '/js/matter/logo_yoyocafe.png' }
            }
        }, true);
    });
    ...
    function matter_addItem() {
        ...
        var itm01 = Bodies.circle(x, y, 24, { //ボールを追加
            ...
            render: { //ボールのレンダリングの設定
                sprite: { texture: wppath + '/js/matter/m_item01h.png' }
            },
        ...
        var itm02 = Bodies.circle(x, y, 24, {
            ...
            render: { sprite: { texture: wppath + '/js/matter/m_item02h.png' } },
            timeScale: 1
        });
        //item02 : ドーナツ
        var itm03 = Bodies.circle(x, y, 24, {
            ...
            render: { sprite: { texture: wppath + '/js/matter/m_item03h.png' } },
            timeScale: 1.5
        });
    ...
    function open_info(i_text) {
        mev_info_count = 100;
        var infof = document.getElementsByClassName('pfe__canvas-infoframe')[0];
        var info = document.getElementsByClassName('pfe__canvas-info')[0];

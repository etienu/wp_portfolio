...
<?php
        ...
        elseif( is_single() ){
            ...
            if ( $category[0] ) {
                ...
                //                echo "　>　<a href='".get_category_link( $category[0]->term_id )."' class='p-breadcrumb__link'>".$category[0]->cat_name."</a>";
                echo "　>　<a href='".get_permalink()."' class='p-breadcrumb__link'>".get_the_title()."</a>";
            }
        }
        //  アーカイブ
...
//                    echo "<a href='".get_category_link( $category[0]->term_id )."' class='p-breadcrumb__link'>".$category[0]->cat_name."</a>";
        ...
        //  検索
        elseif( is_search() ){
            // echo "HOME > ".my_the_post_category( false )." > ".get_the_title();
            //echo "HOME > ".my_the_post_category( false )." > ".get_the_title();
            echo "<a href='".esc_url(home_url())."' class='p-breadcrumb__link'>ホーム</a>";
            echo "　>　";
            echo "検索";

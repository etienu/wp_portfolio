window.onload = function() {
    //	変数
    var path = wppath; // + "/";		//	ページパス
    var imgpath = wppath + "/img/jsmatter/"; //	画像パス
    //	mev = matter event
    ...
    function resizeWindow() {
        ...
        render.options.pixelRatio = 'auto'; //cx / 640;
        // マウスの倍率を修正
    ...
    function open_info(i_text) {
        ...
        var infof = document.getElementsByClassName('pfe__canvas-infoframe')[0]; //	info枠の要素
        var info = document.getElementsByClassName('pfe__canvas-info')[0]; //	infoテキストの要素

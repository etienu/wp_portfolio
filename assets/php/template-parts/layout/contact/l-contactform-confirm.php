    ...
    -->
        ...
        <ul class="p-contact__form-items">
            ...
            <li class="p-contact__form-item">
                <div class="p-contact__form-itemname"><label for="name">お名前</label></div>
            ...
            <!-- メールアドレス -->
            <li class="p-contact__form-item">
                <div class="p-contact__form-itemname"><label for="email">メールアドレス</label></div>
                <div class="p-contact__form-iteminput">
            ...
            <!-- お問い合わせ内容 -->
            <li class="p-contact__form-item">
                <div class="p-contact__form-itemname"><label for="message">お問い合わせ内容</label></div>
                <div class="p-contact__form-iteminput">
            ...
            ?>
                <li class="p-contact__form-check">
                    ...
                    <!--<button class="c-button__portfolio c-button__portfolio--submit c-button__hover__goto p-button__submit" id="js_contact_submit">送信する</button>-->
                    <!--<input type="submit" name="your-submit" class="c-button__portfolio c-button__hover__goto p-button__submit" id="js_contact_submit" value="送信する">-->
                </li>
            <?php

    ...
    <div class="inner">
        ...
        <nav class="footer-sns-buttons">
            <ul>
                ...
                <li><a class="m_facebook" href="https://facebook.com/share.php?u=<?php the_permalink();?>" rel="nofollow" target="_blank">
                ...
                <li><a class="m_pocket" href="https://getpocket.com/edit?url=<?php the_permalink();?>" rel="nofollow" target="_blank">
